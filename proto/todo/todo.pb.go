...
const file_proto_todo_proto_rawDesc = "" +
	"\n" +
	"\x10proto/todo.proto\x12\x04todo\x1a'googleapis/google/api/annotations.proto\"E\n" +
	...
	".todo.TodoR\x05todos2\x95\x01\n" +
	"\vTodoService\x12;\n" +
	"\tListTodos\x12\v.todo.Empty\x1a\x0e.todo.TodoList\"\x11\x82\xd3\xe4\x93\x02\v\x12\t/v1/todos\x12I\n" +
	"\n" +
	"CreateTodo\x12\x11.todo.TodoRequest\x1a\x12.todo.TodoResponse\"\x14\x82\xd3\xe4\x93\x02\x0e:\x01*\"\t/v1/todosB\x19Z\x17microservice/proto;todob\x06proto3"
...
var file_proto_todo_proto_depIdxs = []int32{
	...
	2, // 1: todo.TodoService.ListTodos:input_type -> todo.Empty
	0, // 2: todo.TodoService.CreateTodo:input_type -> todo.TodoRequest
	4, // 3: todo.TodoService.ListTodos:output_type -> todo.TodoList
